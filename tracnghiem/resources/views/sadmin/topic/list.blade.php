                                    ...
                                    <tbody>
                                        @foreach($topic as $tp)
                                           <tr>
                                            ...
                                            <td><a href="sadmin/topic/edit/{{$tp->id}}"><img src="https://cdn1.iconfinder.com/data/icons/real-estate-set-2/512/21-512.png" class="img-responsive " alt="Responsive image" width="16" height="16"></a></td>
	...
	<script>
        ...
        function myFunction(str){
            if (confirm('Bạn có chắc chắn muốn xóa\nXóa chủ đề này cũng sẽ xóa toàn bộ đề và câu hỏi của nó?')){
                window.location.href="sadmin/topic/delete/"+str;
            }
        }
    </script>
@endsection