            ...
            <div class="container-fluid">
                <div class="card">
                            ...
                            <div class="content">
                                ...
                                @endif
                                <form action="sadmin/user/add1" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                                    <h6>Thêm bằng excel</h6>
                                    <input type="file" name="file"><br>
                                    <button type="submit">Thêm</button>
                                </form>
                                <form action="sadmin/user/add" method="post">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control border-input" name='email' required="" placeholder="Email" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="row"> 
                                                <div class="col-xs-4 col-md-4">
                                                    ...
                                                    <input class="form-control border-input" name="year" placeholder="Năm sinh" require="" pattern="[0-9]{4}" title="Nhập sai năm" type="text" id="year">
                                                </div>
                                                <div class="col-xs-4 col-md-4">
                                                    <div>
                                                        <label>Tháng</label>
    ...
    <script>       
        $(document).ready(function(){
        	$.get("sadmin/ajax/gettopic?str="+$('#subject1').val(),function(data){
                $('#topic1').html(data);
                $.get("sadmin/ajax/getexam?str="+$('#topic1').val(),function(data){
                    $('#exam').html(data);
                });
            });
            ...
            $.get("sadmin/ajax/getdate?str="+$('#month').val()+"&str1="+$('#year').val(),function(data){
                    $('#date').html(data);
                });
