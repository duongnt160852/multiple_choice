                                ...
                                <table class="table table-striped" id="table">
                                    ...
                                    <tbody id="body">
                                        @foreach($users as $user)
                                            ...
                                            <td><a href="sadmin/user/edit/{{$user->id}}"><img src="https://cdn1.iconfinder.com/data/icons/real-estate-set-2/512/21-512.png" class="img-responsive " alt="Responsive image" width="16" height="16"></a></td>
    ...
    <script>
        function myFunction(str){
            if (confirm('Bạn có chắc chắn muốn xóa?')){
                window.location.href="sadmin/user/delete/"+str;
            }
        }
    </script>
@endsection