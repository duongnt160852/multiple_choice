                ...
                <nav>
                    ...
                    <li>
                        ...
                        <div id="subAdmin" class="collapse in">
                            <ul class="nav">
                                <li id="adminList" class="active" style="margin: 0px;position: relative;left: 47px;width: 212px">
                                ...
                                <table class="table table-striped" id="table">
                                    ...
                                    <tbody id="body">
                                        @foreach($admin as $ad)
                                            ...
                                            <td>{{$ad->username}}</td>
                                            <td>{{$ad->email}}</td>
                                            <td><a onclick="myFunction({{$ad->id}})" style="cursor: pointer;"><img src="https://cdn2.iconfinder.com/data/icons/basic-ui-elements-plain/448/010_trash-512.png" class="img-responsive " alt="Responsive image" width="16" height="16"></a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
...
@section('script')
    ...
    <script>
    $("title").html("Danh sách admin");
    </script>
    <script>
        function myFunction(str){
            if (confirm('Bạn có chắc chắn muốn xóa?')){
                window.location.href="sadmin/admin/delete/"+str;
            }
        }
    </script>
@endsection