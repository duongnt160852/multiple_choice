...
<div class="wrapper">
    ...
    -->
        ...
        <div class="sidebar-wrapper">
            ...
            <div id="clock" class="logo" align="center" style="font-size: 20px">
            ...
            @for($i=0;$i<count($exam);$i++)
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="radio" name="{{$i+1}}" value="A" placeholder=""> A. {!! $exam[$i]->question[0]->A !!}
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <input type="radio" name="{{$i+1}}" value="B" placeholder=""> B. {!! $exam[$i]->question[0]->B !!}
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <input type="radio" name="{{$i+1}}" value="C" placeholder=""> C. {!! $exam[$i]->question[0]->C !!}
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <input type="radio" name="{{$i+1}}" value="D" placeholder=""> D. {!! $exam[$i]->question[0]->D !!}
                    </div>
                </div>
            @endfor
